...
Java_com_follow_mbzeguardx_core_Core_startTun(JNIEnv *env, jobject, const jint fd, jobject cb) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_follow_mbzeguardx_core_Core_stopTun(JNIEnv *) {
    stopTun();
}
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    const auto c_tun_interface = find_class("com/follow/mbzeguardx/core/TunInterface");
