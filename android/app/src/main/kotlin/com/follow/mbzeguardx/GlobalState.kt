...
import com.follow.mbzeguardx.plugins.VpnPlugin
...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL = "MBzeGuardX"
    ...
    fun initServiceEngine() {
        ...
        destroyServiceEngine()
        runLock.withLock {
            serviceEngine = FlutterEngine(MBzeGuardXApplication.getAppContext())
