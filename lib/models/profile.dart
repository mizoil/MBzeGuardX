...
import 'package:mbzeguardx/clash/core.dart';
import 'package:mbzeguardx/common/common.dart';
import 'package:mbzeguardx/enum/enum.dart';
import 'package:freezed_annotation/freezed_annotation.dart';
import 'package:mbzeguardx/utils/device_info_service.dart';
...
extension ProfileExtension on Profile {
  ...
  Future<Profile> update({bool shouldSendHeaders = true}) async {
    ...
    final dashboardHeader = response.headers.value('mbzeguardx-widgets');
    final serviceName = response.headers.value('mbzeguardx-servicename');
    final customBehavior = response.headers.value('mbzeguardx-custom');

    final denyWidgetHeader = response.headers.value('mbzeguardx-denywidgets');
    ...
    final proxiesViewHeader = response.headers.value('mbzeguardx-view');
